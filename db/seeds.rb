...
celso_t = Toilet.create!(name: "The Duchess", price: 50, address: "3-chōme-2 Takaban, Meguro City, Tokyo 152-0004", short_description: "Change your life with a ride on the Duchess.", description: "The Duchess is a horse-shaped toilet crafted from glossy porcelain with antique gold accents. The horse’s head forms the tank, while the flowing mane and tail add elegance and stability.", user: celso)
...
yann_t = Toilet.create(name: "The Golden Throne", price: 1, address: "2 Chome-6-14 Megurohoncho, Meguro City, Tokyo 152-0002", short_description: "The Toilet formerly known as The Alisa." , description: "This luxurious Golden and Marble Elegant Toilet combines the timeless beauty of marble with the opulence of gold accents. The smooth marble surface and rich gold fixtures create a stunning contrast, adding sophistication and grandeur to any bathroom. Perfect for upscale spaces, it offers both elegance and modern functionality for an unforgettable bathroom experience.", user: yann)
...
will_t = Toilet.create(name: "The Cadillac", price: 800, address: "2 Chome-11-3 Meguro, Meguro City, Tokyo 153-0063", short_description: "Drop off the kids in the Caddy!" , description: "Experience the perfect blend of style and comfort with the Cadillac Toilet. Inspired by the sleek lines and elegance of a Cadillac, this toilet offers plush seating and smooth, efficient performance. A true statement piece for those who appreciate luxury, it brings automotive flair and first-class comfort to your bathroom.", user: will)
...
stuart_t = Toilet.create!(name: "Hello Kitty", price: 50, address: "153-0064 Tokyo, Meguro City, Shimomeguro, 2 Chome−2−10 The Edge目黒 402", short_description: "strong params", description: "strong params", user: celso)
file = File.open("app/assets/images/10.png")
stuart_t.photos.attach(io: file, filename: "scary.jpg", content_type: "image/jpg")
stuart_t.save

alisa_t = Toilet.create(name: "Cool Biz", price: 100, address: "153-0064 Tokyo, Meguro City, Shimomeguro, 2 Chome−21−28 セントヒルズ目黒 2F", short_description: "for relaxing times", description: "for relaxing times", user: doug)
file = File.open("app/assets/images/chains.jpg")
alisa_t.photos.attach(io: file, filename: "chains.jpg", content_type: "image/jpg")
alisa_t.save

denis_t = Toilet.create(name: "Captain AND Tenille", price: 1, address: "153-0063 Tokyo, Meguro City, Meguro, 1 Chome−4−16 目黒Gビル 1F", short_description: "good god, you're going to have fun", description: "good god, you're going to have fun", user: yann)
file = File.open("app/assets/images/scary.jpg")
denis_t.photos.attach(io: file, filename: "scary.jpg", content_type: "image/jpg")
denis_t.save

toilet = Toilet.create!(name: "Turdmuncher 10,000", price: (500..2000).to_a.sample, address: "5 Chome-12-6 Shirokanedai, Minato City, Tokyo 108-0071", short_description: "We've munched 9,999. You're 10,000!", description: "#{Faker::Quote.most_interesting_man_in_the_world}", user: [yann, stuart, denis, alisa, doug, celso].sample)
