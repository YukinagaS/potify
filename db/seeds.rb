...
doug_t = Toilet.create(name: "Grandma's Party", price: 100, address: "2 Chome-6-14 Megurohoncho, Meguro City, Tokyo 152-0002", short_description: "Ideal for couples" , description: "Ideal for couples", user: doug)
...
stuart_t = Toilet.create!(name: "Hello Kitty", price: 50, address: "153-0063 Tokyo, Meguro City, Meguro, 1 Chome−4−16 目黒Gビル 1F", short_description: "strong params", description: "strong params", user: celso)
file = File.open("app/assets/images/scary.jpg")
stuart_t.photos.attach(io: file, filename: "scary.jpg", content_type: "image/jpg")
stuart_t.save


alisa_t = Toilet.create(name: "Cool Biz", price: 100, address: "153-0064 Tokyo, Meguro City, Shimomeguro, 2 Chome−2−10 The Edge目黒 402", short_description: "for relaxing times", description: "for relaxing times", user: doug)
file = File.open("app/assets/images/chains.jpg")
alisa_t.photos.attach(io: file, filename: "chains.jpg", content_type: "image/jpg")
alisa_t.save


denis_t = Toilet.create(name: "Captain AND Tenille", price: 1, address: "153-0064 Tokyo, Meguro City, Shimomeguro, 2 Chome−21−28 セントヒルズ目黒 2F", short_description: "good god, you're going to have fun", description: "good god, you're going to have fun", user: yann)
file = File.open("app/assets/images/scary.jpg")
